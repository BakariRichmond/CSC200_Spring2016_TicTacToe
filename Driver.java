...
public class Driver 
{
	...
	static void playGame()
	{
		...
		Driver.displayBoard();
		System.out.print("(X Turn) Please enter a row:");
		int rowX = Driver.getIntFromUser();
		System.out.print("(X Turn) Please enter a column:");
		int columnX = Driver.getIntFromUser();
		Driver.makeMoveX(rowX, columnX, 'X');
			
		Driver.displayBoard();
		System.out.print("(O Turn) Please enter a row:");
		int rowO = Driver.getIntFromUser();
		System.out.print("(O Turn) Please enter a column:");
		int columnO = Driver.getIntFromUser();
		Driver.makeMoveO(rowO, columnO, 'O');
	...
	static void makeMoveX(int rowX, int column, char move)
	{
		char[] theRow = row1;
		if(rowX == 2)
		{
	...
	static void makeMoveO(int rowO, int column, char move)
	{
		char[] theRow = row1;
		if(rowO == 2)
		{
